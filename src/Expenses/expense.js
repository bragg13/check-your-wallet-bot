...
import { categoryKeyboard, expenseKeyboard, customCategoryKeyboard } from "../Expenses/expenseKeyboards.js";
    ...
    switch (ctx.message.text) {
      ...
      case '🏺 Set category...':
        ...
        if (ctx.message.text == '🫠 Custom...') {
          ...
          let _msg = (conversation.session.user.custom_categories.length === 0)
          ...
          await ctx.reply(_msg, {
            reply_markup: customCategoryKeyboard(conversation.session.user.custom_categories)
          });
